...
class ManageUserSocialTest extends TestCase
{
    ...
    /** @test */
    public function an_admin_can_remove_user_social_account_from_a_user(): void
    {
        $this->loginAsAdmin();
    ...
    /** @test */
    public function an_admin_can_remove_user_social_account_from_a_deleted_user(): void
    {
        $this->loginAsAdmin();
