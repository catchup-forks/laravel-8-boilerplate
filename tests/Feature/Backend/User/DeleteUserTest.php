...
class DeleteUserTest extends TestCase
{
    ...
    /** @test */
    public function an_admin_can_access_deleted_users_page(): void
    {
        $this->loginAsAdmin();
    ...
    /** @test */
    public function a_user_must_be_soft_deleted_before_permanently_deleted(): void
    {
        $this->loginAsAdmin();
    ...
    /** @test */
    public function an_admin_can_restore_users(): void
    {
        $this->loginAsAdmin();
    ...
    /** @test */
    public function a_user_can_be_permanently_deleted(): void
    {
        $this->loginAsAdmin();
        $user = factory(User::class)->states('softDeleted')->create();
        Event::fake();
    ...
    /** @test */
    public function a_not_deleted_user_cant_be_restored(): void
    {
        $this->loginAsAdmin();
        $user = factory(User::class)->create();
