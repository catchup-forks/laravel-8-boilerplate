...
class CreateUserTest extends TestCase
{
    ...
    /** @test */
    public function an_admin_can_access_the_create_user_page(): void
    {
        $this->loginAsAdmin();
    ...
    /** @test */
    public function create_user_has_required_fields(): void
    {
        $this->loginAsAdmin();
    ...
    /** @test */
    public function user_email_needs_to_be_unique(): void
    {
        $this->loginAsAdmin();
    ...
    /** @test */
    public function when_an_unconfirmed_user_is_created_a_notification_will_be_sent(): void
    {
        $this->loginAsAdmin();
        Notification::fake();
