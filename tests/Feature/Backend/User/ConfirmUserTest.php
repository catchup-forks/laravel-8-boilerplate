...
class ConfirmUserTest extends TestCase
{
    ...
    /** @test */
    public function an_admin_can_confirm_a_user(): void
    {
        $this->loginAsAdmin();
    ...
    /** @test */
    public function an_admin_cannot_confirm_a_confirmed_user(): void
    {
        $this->loginAsAdmin();
    ...
    /** @test */
    public function a_newly_confirmed_user_gets_notified_when_approved(): void
    {
    ...
    /** @test */
    public function an_admin_can_unconfirm_a_user(): void
    {
        $this->loginAsAdmin();
        $user = factory(User::class)->states('confirmed')->create();
    ...
    /** @test */
    public function an_admin_cannot_unconfirm_an_unconfirmed_user(): void
    {
        $this->loginAsAdmin();
        $user = factory(User::class)->states('unconfirmed')->create();
    ...
    /** @test */
    public function an_admin_cannot_be_unconfirmed(): void
    {
    ...
    /** @test */
    public function a_user_cannot_unconfirm_self(): void
    {
        $this->loginAsAdmin();
    ...
    /** @test */
    public function an_admin_can_confirm_a_deleted_user(): void
    {
        $this->loginAsAdmin();
    ...
    /** @test */
    public function an_admin_can_unconfirm_a_deleted_user(): void
    {
        $this->loginAsAdmin();
