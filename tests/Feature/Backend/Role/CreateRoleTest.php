...
class CreateRoleTest extends TestCase
{
    ...
    /** @test */
    public function an_admin_can_access_the_create_role_page(): void
    {
        $this->loginAsAdmin();
    ...
    /** @test */
    public function the_name_must_be_unique(): void
    {
        $this->loginAsAdmin();
    ...
    /** @test */
    public function at_least_one_permission_is_required(): void
    {
        $this->loginAsAdmin();
    ...
    /** @test */
    public function a_role_can_be_created(): void
    {
        $this->loginAsAdmin();
