...
class ChangePasswordTest extends TestCase
{
    ...
    /** @test */
    public function the_password_can_be_changed(): void
    {
        $user = factory(User::class)->create(['password' => '1234']);
    ...
    /** @test */
    public function the_old_password_is_required_in_the_password_change_form(): void
    {
    ...
    /** @test */
    public function a_user_can_use_the_same_password_when_history_is_off_on_account_change_password(): void
    {
    ...
    /** @test */
    public function a_user_can_not_use_the_same_password_when_history_is_on_on_account_change_password(): void
    {
    ...
    /** @test */
    public function a_user_can_reuse_a_password_after_it_surpasses_the_limit(): void
    {
