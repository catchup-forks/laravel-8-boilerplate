...
class PasswordExpirationTest extends TestCase
{
    ...
    /** @test */
    public function a_user_is_requested_to_change_their_password_after_it_expires(): void
    {
    ...
    /** @test */
    public function a_user_is_not_requested_to_change_their_password_if_it_not_old_enough(): void
    {
        config(['access.users.password_expires_days' => 30]);
    ...
    /** @test */
    public function a_user_is_not_requested_to_change_password_if_expiration_is_off(): void
    {
    ...
    /** @test */
    public function a_user_can_use_the_same_password_when_history_is_off_on_password_expiration(): void
    {
        config(['access.users.password_history' => false]);
        config(['access.users.password_expires_days' => 30]);
    ...
    /** @test */
    public function a_user_can_not_use_the_same_password_when_history_is_on_on_password_expiration(): void
    {
