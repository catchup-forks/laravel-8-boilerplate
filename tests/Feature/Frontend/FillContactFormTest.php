...
{
    /** @test */
    public function the_contact_route_exists(): void
    {
        $this->get('/contact')->assertStatus(200);
    }

    /** @test */
    public function a_contact_mail_gets_sent(): void
    {
        Mail::fake();
    ...
    /** @test */
    public function it_redirects_back_after_success(): void
    {
    ...
    /** @test */
    public function phone_number_is_not_required(): void
    {
        Mail::fake();
