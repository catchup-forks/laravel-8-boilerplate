...
class UserRegistrationTest extends TestCase
{
    ...
    /** @test */
    public function the_register_route_exists(): void
    {
        $this->get('/register')->assertStatus(200);
    }

    /** @test */
    public function user_registration_can_be_disabled(): void
    {
    ...
    /** @test */
    public function a_user_can_register_an_account(): void
    {
        $this->registerUser([
            'first_name'            => 'John',
            'last_name'             => 'Doe',
    ...
    /** @test */
    public function if_email_confirmation_is_active_an_notification_gets_sent(): void
    {
    ...
    /** @test */
    public function a_user_account_can_confirm_his_email(): void
    {
    ...
    /** @test */
    public function confirmation_can_be_resent(): void
    {
        Notification::fake();
    ...
    /** @test */
    public function if_requires_approval_is_active_the_user_cant_login(): void
    {
    ...
    /** @test */
    public function an_event_get_fired_on_registration(): void
    {
    ...
    /** @test */
    public function passwords_must_be_equivalent(): void
    {
        $response = $this->post('/register', [
            'first_name'            => 'John',
            'last_name'             => 'Doe',
    ...
    /** @test */
    public function it_redirects_to_dashboard_after_successful_registration(): void
    {
