...
class ResetPasswordTest extends TestCase
{
    ...
    /** @test */
    public function the_password_reset_route_exists(): void
    {
        $this->get('password/reset')->assertStatus(200);
    }

    /** @test */
    public function email_is_required_in_email_password_form(): void
    {
    ...
    /** @test */
    public function a_notification_gets_sent_if_password_reset_is_requested(): void
    {
    ...
    /** @test */
    public function the_reset_password_form_has_required_fields(): void
    {
    ...
    /** @test */
    public function a_password_can_be_reset(): void
    {
        $user = factory(User::class)->create(['email' => 'john@example.com']);
    ...
    /** @test */
    public function a_user_can_use_the_same_password_when_history_is_off_on_password_reset(): void
    {
    ...
    /** @test */
    public function a_user_can_not_use_the_same_password_when_history_is_on_on_password_reset(): void
    {
