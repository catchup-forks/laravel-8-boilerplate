...
class UserLoginTest extends TestCase
{
    ...
    /** @test */
    public function the_login_route_exists(): void
    {
    ...
    /** @test */
    public function inactive_users_cant_login(): void
    {
    ...
    /** @test */
    public function unconfirmed_user_cant_login(): void
    {
    ...
    /** @test */
    public function cant_login_with_invalid_credentials(): void
    {
