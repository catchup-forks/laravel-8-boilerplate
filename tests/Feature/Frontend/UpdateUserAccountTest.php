...
class UpdateUserAccountTest extends TestCase
{
    ...
    /** @test */
    public function a_user_can_update_his_profile(): void
    {
    ...
    /** @test */
    public function the_first_name_is_required(): void
    {
        $user = factory(User::class)->create();
    ...
    /** @test */
    public function the_last_name_is_required(): void
    {
        $user = factory(User::class)->create();
    ...
    /** @test */
    public function the_avatar_type_is_required(): void
    {
        $user = factory(User::class)->create();
    ...
    /** @test */
    public function a_user_can_upload_his_own_avatar(): void
    {
        $user = factory(User::class)->create();
        Storage::fake('public');
    ...
    /** @test */
    public function the_email_needs_to_be_confirmed_if_confirm_email_is_true(): void
    {
        $user = factory(User::class)->create();
    ...
    /** @test */
    public function the_email_needs_not_to_be_confirmed_if_confirm_email_is_false(): void
    {
        $user = factory(User::class)->create();
