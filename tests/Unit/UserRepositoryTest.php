...
class UserRepositoryTest extends TestCase
{
    ...
    /** @test */
    public function it_can_count_unconfirmed_users(): void
    {
    ...
    /** @test */
    public function it_can_paginate_the_active_users(): void
    {
    ...
    /** @test */
    public function it_can_paginate_the_inactive_users(): void
    {
        factory(User::class, 30)->create();
    ...
    /** @test */
    public function it_can_paginate_the_soft_deleted_inactive_users(): void
    {
        factory(User::class, 30)->create();
    ...
    /** @test */
    public function it_can_create_new_users(): void
    {
    ...
    /** @test */
    public function it_can_update_existing_users(): void
    {
        $initialDispatcher = Event::getFacadeRoot();
        Event::fake();
        Model::setEventDispatcher($initialDispatcher);
